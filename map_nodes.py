...
instructor_nodes = {
    ...
    15: [45, 47, 46, 19, 21, 43], # Tile 15 NE of 5, E of 14: T=50, TR=51, BR=49, B=46, BL=48, TL=47
    16: [46, 48, 49, 22, 20, 19], # Tile 16 E of 5, NE of 6: T=49, TR=54, BR=55, B=21, BL=48, TL=46
    17: [49, 50, 51, 52, 23, 22], # Tile 17 E of 6, NE of 1: T=21, TR=55, BR=56, B=52, BL=22, TL=49
    18: [23, 52, 53, 24, 7, 6], # Tile 18 SE of 6, E of 1: T=22, TR=56, BR=57, B=53, BL=52, TL=23 
}
